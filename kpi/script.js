...
function _riskMeasuresRaw(r) {
  ...
  out.forEach(function (p) {
    ...
    var dep = /^(?:боломжтой бол|боломжоор|шаардлагатай бол|шаардвал|зайлшгүй бол|хэрэв|хэрвээ|мөн |түүнчлэн|эсвэл|эсхүл|ингэснээр|тэгэхдээ|цаашид|улмаар|зэргийг|түүний|үүний)/i.test(t);
    if ((dep || t.length < 15) && fin.length) { fin[fin.length - 1] += ', ' + t; return; }
    fin.push(t);
  });
